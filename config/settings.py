...
PAYPAL_RECEIVER_EMAIL = "sb-v6hdk39673513@business.example.com" # sandbox email 
PAYPAL_TEST = True # sandbox mode IF True production mode IF False  
        ...
        "navigation": [
            {
                ...
                "items": [
                    ...
                    {
                        "title": _("Checkout"),
                        "icon": "draft_orders",  # Supported icon set: https://fonts.google.com/icons
                        "link": reverse_lazy("admin:checkout_checkoutitem_changelist"),
                        "permission": lambda request: request.user.is_superuser,
                    },
                ],
            },
